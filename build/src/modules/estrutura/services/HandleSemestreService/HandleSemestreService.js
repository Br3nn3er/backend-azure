...
exports.HandleSemestreService = void 0;
var csv_parse_1 = __importDefault(require("csv-parse"));
var fs_1 = __importDefault(require("fs"));
var tsyringe_1 = require("tsyringe");
var AppError_1 = require("../../../../shared/errors/AppError");
var HandleSemestreService = /** @class */ (function () {
    function HandleSemestreService(semestresRepository) {
    ...
    HandleSemestreService.prototype.readById = function (id) {
    ...
    HandleSemestreService.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.semestresRepository.deleteById(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HandleSemestreService.prototype.import = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            var semestres;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadSemestres(file)];
                    case 1:
                        semestres = _a.sent();
                        semestres.map(function (semestreToImport) { return __awaiter(_this, void 0, void 0, function () {
                            var ano, semestre, status, foundedSemestre;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ano = semestreToImport.ano, semestre = semestreToImport.semestre, status = semestreToImport.status;
                                        return [4 /*yield*/, this.semestresRepository.queryByAnoSemestre(ano, semestre)];
                                    case 1:
                                        foundedSemestre = _a.sent();
                                        if (!!foundedSemestre) return [3 /*break*/, 3];
                                        return [4 /*yield*/, this.semestresRepository.createSemestre({
                                                ano: ano,
                                                semestre: semestre,
                                                status: status,
    ...
    HandleSemestreService.prototype.loadSemestres = function (file) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            parseFile
                ...
                var ano, semestre, status;
                return __generator(this, function (_a) {
                    ano = line[0], semestre = line[1], status = line[2];
                    semestres.push({
                        ano: ano,
                        semestre: semestre,
    ...
    HandleSemestreService = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)("SemestresRepository")),
        __metadata("design:paramtypes", [Object])
    ], HandleSemestreService);
    return HandleSemestreService;
}());
exports.HandleSemestreService = HandleSemestreService;
