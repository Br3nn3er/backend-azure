...
var HandleMinistraService = /** @class */ (function () {
    function HandleMinistraService(ministraRepository, turmaRepository, semestresRepository) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.ministraRepository.create({
                                siape: siape,
                                id_turma: id_turma,
                            })];
                }
    ...
    HandleMinistraService.prototype.readByProfessorAndSemestre = function (siapes, semestreId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, ano, semestre;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.ministraRepository.listMinistraByProfessorAndSemestre(siapes, ano, semestre)];
                }
            });
        });
    };
    HandleMinistraService.prototype.readByTurmaAndSemestre = function (turmaIds, semestreId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, ano, semestre;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), ano = _a.ano, semestre = _a.semestre;
                        return [2 /*return*/, this.ministraRepository.listByTurmasAndSemestre(turmaIds, ano, semestre)];
                }
            });
        });
    };
    ...
    HandleMinistraService = __decorate([
        ...
        __param(0, (0, tsyringe_1.inject)("MinistraRepository")),
        __param(1, (0, tsyringe_1.inject)("TurmasRepository")),
        __param(2, (0, tsyringe_1.inject)("SemestresRepository")),
