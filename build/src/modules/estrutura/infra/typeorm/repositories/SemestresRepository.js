...
var SemestresRepository = /** @class */ (function () {
    ...
    SemestresRepository.prototype.createSemestre = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        semestreToCreate = this.repository.create({
                            ano: ano,
                            semestre: semestre,
                            status: status,
                        });
                        return [4 /*yield*/, this.repository.save(semestreToCreate)];
                    case 1:
                        _b.sent();
    ...
    SemestresRepository.prototype.updateById = function (_a) {
                    ...
                    case 1:
                        ...
                        semestreToUpdate.status =
                            status === null || status === undefined
                                ? semestreToUpdate.status
                                : status;
                        return [4 /*yield*/, this.repository.save(semestreToUpdate)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/, semestreToUpdate];
                }
            });
        });
    };
    SemestresRepository.prototype.deleteById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return SemestresRepository;
}());
exports.SemestresRepository = SemestresRepository;
