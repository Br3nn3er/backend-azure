...
var HorariosRepository = /** @class */ (function () {
    ...
    HorariosRepository.prototype.updateHorarioByLetra = function (_a) {
        var letra = _a.letra, hora_inicio = _a.hora_inicio, hora_fim = _a.hora_fim, turno = _a.turno;
        return __awaiter(this, void 0, void 0, function () {
            var horarioToUpdate;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.repository.save(horarioToUpdate)];
                    case 2:
                        _b.sent();
    ...
    HorariosRepository.prototype.deleteByLetra = function (letra) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.delete(letra)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
