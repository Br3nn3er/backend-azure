...
var CargaDocentesRepository = /** @class */ (function () {
    ...
    CargaDocentesRepository.prototype.updateBySiape = function (_a) {
        var siape = _a.siape, carga_atual = _a.carga_atual, ano = _a.ano, semestre = _a.semestre;
        return __awaiter(this, void 0, void 0, function () {
            var cargaToUpdate;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.repository.save(cargaToUpdate)];
                    case 2:
                        _b.sent();
    ...
    CargaDocentesRepository.prototype.deleteBySiape = function (siape) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository
                            .createQueryBuilder()
                            .delete()
                            .from(CargaDocente_1.CargaDocente)
    ...
    return CargaDocentesRepository;
}());
exports.CargaDocentesRepository = CargaDocentesRepository;
