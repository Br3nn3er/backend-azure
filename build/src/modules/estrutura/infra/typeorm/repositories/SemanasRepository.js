...
var SemanasRepository = /** @class */ (function () {
    ...
    SemanasRepository.prototype.update = function (_a) {
        var dia = _a.dia, descricao = _a.descricao;
        return __awaiter(this, void 0, void 0, function () {
            var semana;
            return __generator(this, function (_b) {
    ...
    SemanasRepository.prototype.deleteByDia = function (dia) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.delete(dia)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return SemanasRepository;
}());
exports.SemanasRepository = SemanasRepository;
