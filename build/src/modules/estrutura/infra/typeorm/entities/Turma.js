...
var Turma = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Disciplina_1.Disciplina; }),
        (0, typeorm_1.JoinColumn)({ name: "codigo_disc" }),
        __metadata("design:type", Disciplina_1.Disciplina)
    ], Turma.prototype, "disciplina", void 0);
    __decorate([
        (0, typeorm_1.OneToOne)(function () { return FilaTurmaNew_1.FilaTurmaNew; }),
        (0, typeorm_1.JoinColumn)({ name: "id", referencedColumnName: "id_turma" }),
        __metadata("design:type", FilaTurmaNew_1.FilaTurmaNew)
    ], Turma.prototype, "fila_turma_new", void 0);
    __decorate([
        (0, typeorm_1.Column)({
            transformer: {
                from: function (value) { return value.trim(); },
