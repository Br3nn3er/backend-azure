...
var OfertaRepository = /** @class */ (function () {
    ...
    OfertaRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        oferta = this.repository.create({ dia: dia, letra: letra, id_turma: id_turma });
                        return [4 /*yield*/, this.repository.save(oferta)];
                    case 1:
                        _b.sent();
    ...
    OfertaRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.OfertaRepository = OfertaRepository;
