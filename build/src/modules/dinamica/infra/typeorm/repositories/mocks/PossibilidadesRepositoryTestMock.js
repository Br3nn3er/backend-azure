...
var PossibilidadesRepositoryTestMock = /** @class */ (function () {
    ...
    PossibilidadesRepositoryTestMock.prototype.queryById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.possibilidades.find(function (possibilidade) { return possibilidade.id === id; })];
            });
        });
    };
    PossibilidadesRepositoryTestMock.prototype.queryByNumCenario = function (num_cenario) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.possibilidades.find(function (possibilidade) { return possibilidade.num_cenario === num_cenario; })];
            });
        });
    };
