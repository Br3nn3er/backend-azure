...
var FilaTurmaNewRepositoryTestMock = /** @class */ (function () {
    ...
    FilaTurmaNewRepositoryTestMock.prototype.queryByTurmaEFila = function (id_turma, id_fila) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.listFilasTurma.find(function (fila) { return fila.id_turma === id_turma && fila.id_fila === id_fila; })];
            });
        });
    };
    ...
    FilaTurmaNewRepositoryTestMock.prototype.readByProfessorAndSemestreExcludingProfessor = function (siape, semestre, ano) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.listFilasTurma.filter(function (fila) {
                        return fila.fila.siape !== siape &&
