...
exports.RestricoesRepositoryTestMock = void 0;
var Restricoes_1 = require("../../entities/Restricoes");
var RestricoesRepositoryTestMock = /** @class */ (function () {
    function RestricoesRepositoryTestMock() {
        this.restricoesList = [];
    }
    RestricoesRepositoryTestMock.prototype.createMany = function (data) {
        throw new Error("Method not implemented.");
    };
    RestricoesRepositoryTestMock.prototype.deleteBySiape = function (siape) {
        throw new Error("Method not implemented.");
    };
    RestricoesRepositoryTestMock.prototype.create = function (_a) {
        var siape = _a.siape, dia = _a.dia, letra = _a.letra;
        return __awaiter(this, void 0, void 0, function () {
            var restricoes;
            return __generator(this, function (_b) {
                restricoes = new Restricoes_1.Restricoes();
                Object.assign(restricoes, { siape: siape, dia: dia, letra: letra });
                this.restricoesList.push(restricoes);
                return [2 /*return*/, restricoes];
            });
        });
    };
    RestricoesRepositoryTestMock.prototype.listRestricoes = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.restricoesList];
            });
        });
    };
    ...
    RestricoesRepositoryTestMock.prototype.deleteBySiapeEDiaELetra = function (siape, dia, letra) {
        return __awaiter(this, void 0, void 0, function () {
            var restricoesIndex;
            return __generator(this, function (_a) {
                restricoesIndex = this.restricoesList.findIndex(function (restricoesToSearch) {
                    return restricoesToSearch.siape === siape &&
                        restricoesToSearch.dia === dia &&
                        restricoesToSearch.letra === letra;
                });
    ...
    return RestricoesRepositoryTestMock;
}());
exports.RestricoesRepositoryTestMock = RestricoesRepositoryTestMock;
