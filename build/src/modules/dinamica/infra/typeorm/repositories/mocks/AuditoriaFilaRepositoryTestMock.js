...
var AuditoriaFilaRepositoryTestMock = /** @class */ (function () {
    ...
    AuditoriaFilaRepositoryTestMock.prototype.queryById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.auditorias.find(function (auditoriaToSearch) { return auditoriaToSearch.id === id; })];
            });
        });
    };
    AuditoriaFilaRepositoryTestMock.prototype.queryBySiape = function (siape) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.auditorias.find(function (auditoriaToSearch) { return auditoriaToSearch.siape === siape; })];
            });
        });
    };
