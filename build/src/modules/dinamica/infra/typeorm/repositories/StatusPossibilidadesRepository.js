...
var StatusPossibilidadesRepository = /** @class */ (function () {
    ...
    StatusPossibilidadesRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        statusPossibilidade = this.repository.create({
                            id_fila: id_fila,
                            id_possibilidade: id_possibilidade,
                            status: status,
                        });
                        console.log(statusPossibilidade);
                        return [4 /*yield*/, this.repository.save(statusPossibilidade)];
                    case 1:
                        _b.sent();
    ...
    StatusPossibilidadesRepository.prototype.deleteByFilaEPossibilidade = function (id_fila, id_possibilidade) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository
                            .createQueryBuilder()
                            .delete()
                            .from(StatusPossibilidades_1.StatusPossibilidades)
                            .where("id_fila = :id_fila", { id_fila: id_fila })
                            .andWhere("id_possibilidade = :id_possibilidade", { id_possibilidade: id_possibilidade })
                            .execute()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    return StatusPossibilidadesRepository;
}());
exports.StatusPossibilidadesRepository = StatusPossibilidadesRepository;
