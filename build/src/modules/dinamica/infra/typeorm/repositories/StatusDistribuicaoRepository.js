...
var StatusDistribuicaoRepository = /** @class */ (function () {
    ...
    StatusDistribuicaoRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        status = this.repository.create({ id: id, descricao: descricao });
                        return [4 /*yield*/, this.repository.save(status)];
                    case 1:
                        _b.sent();
    ...
    StatusDistribuicaoRepository.prototype.updateByCodigo = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.repository.save(statusFounded)];
                    case 2:
                        _b.sent();
    ...
    StatusDistribuicaoRepository.prototype.deleteByCodigo = function (codigo) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return StatusDistribuicaoRepository;
}());
exports.StatusDistribuicaoRepository = StatusDistribuicaoRepository;
