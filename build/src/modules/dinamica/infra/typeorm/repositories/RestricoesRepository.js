...
var RestricoesRepository = /** @class */ (function () {
    ...
    RestricoesRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        restricoes = this.repository.create({ siape: siape, dia: dia, letra: letra });
                        return [4 /*yield*/, this.repository.save(restricoes)];
                    case 1:
                        _b.sent();
    ...
    RestricoesRepository.prototype.createMany = function (data) {
        var restricoes = this.repository.create(data);
        return this.repository.save(restricoes);
    };
    RestricoesRepository.prototype.deleteBySiape = function (siape) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RestricoesRepository.prototype.deleteBySiapeEDiaELetra = function (siape, dia, letra) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository
                            .createQueryBuilder()
                            .delete()
                            .from(Restricoes_1.Restricoes)
                            .where("siape = :siape", { siape: siape })
                            .andWhere("dia = :dia", { dia: dia })
                            .andWhere("letra = :letra", { letra: letra })
                            .execute()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    return RestricoesRepository;
}());
exports.RestricoesRepository = RestricoesRepository;
