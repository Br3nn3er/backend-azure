...
var AtribuicaoManualRepository = /** @class */ (function () {
    ...
    AtribuicaoManualRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        atribuicao = this.repository.create({ num_cenario: num_cenario, siape: siape, id_turma: id_turma });
                        return [4 /*yield*/, this.repository.save(atribuicao)];
                    case 1:
                        _b.sent();
    ...
    AtribuicaoManualRepository.prototype.deleteByCenarioETurma = function (num_cenario, id_turma) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository
                            .createQueryBuilder()
                            .delete()
                            .from(AtribuicaoManual_1.AtribuicaoManual)
    ...
    return AtribuicaoManualRepository;
}());
exports.AtribuicaoManualRepository = AtribuicaoManualRepository;
