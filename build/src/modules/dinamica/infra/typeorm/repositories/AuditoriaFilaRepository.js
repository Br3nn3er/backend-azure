...
var AuditoriaFilaRepository = /** @class */ (function () {
    ...
    AuditoriaFilaRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        auditoria = this.repository.create({
                            siape: siape,
    ...
    AuditoriaFilaRepository.prototype.updateById = function (_a) {
    ...
    AuditoriaFilaRepository.prototype.deleteById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return AuditoriaFilaRepository;
}());
exports.AuditoriaFilaRepository = AuditoriaFilaRepository;
