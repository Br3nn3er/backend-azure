...
var CenarioFilaTurma = /** @class */ (function () {
    ...
    __decorate([
        ...
        (0, typeorm_1.JoinColumn)({ name: "num_cenario" }),
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return FilaTurmaNew_1.FilaTurmaNew; }),
        (0, typeorm_1.JoinColumn)([{ name: "id_turma" }, { name: "id_fila" }]),
    ...
    CenarioFilaTurma = __decorate([
        (0, typeorm_1.Entity)("cenario_fila_turma")
    ], CenarioFilaTurma);
