...
var StatusPossibilidades = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Fila_1.Fila; }),
        (0, typeorm_1.JoinColumn)({ name: "id_fila" }),
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Possibilidades_1.Possibilidades; }),
        (0, typeorm_1.JoinColumn)({ name: "id_possibilidade" }),
    ...
    StatusPossibilidades = __decorate([
        (0, typeorm_1.Entity)("status_possibilidades")
