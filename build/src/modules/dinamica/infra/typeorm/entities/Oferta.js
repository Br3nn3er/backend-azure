...
var Oferta = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Semana_1.Semana; }),
        (0, typeorm_1.JoinColumn)({ name: "dia" }),
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Horario_1.Horario; }),
        (0, typeorm_1.JoinColumn)({ name: "letra" }),
