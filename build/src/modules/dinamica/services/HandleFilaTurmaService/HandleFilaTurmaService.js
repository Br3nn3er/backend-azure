...
exports.HandleFilaTurmaService = void 0;
var tsyringe_1 = require("tsyringe");
var AppError_1 = require("../../../../shared/errors/AppError");
var HandleFilaTurmaService = /** @class */ (function () {
    function HandleFilaTurmaService(filaTurmaRepository) {
        this.filaTurmaRepository = filaTurmaRepository;
    }
    ...
    HandleFilaTurmaService.prototype.update = function (_a) {
        var siape = _a.siape, id_turma = _a.id_turma, codigo_disc = _a.codigo_disc, turma = _a.turma, pos = _a.pos, prioridade = _a.prioridade, qte_ministrada = _a.qte_ministrada, qte_maximo = _a.qte_maximo, status = _a.status, ch = _a.ch, id = _a.id, periodo_preferencial = _a.periodo_preferencial;
        return __awaiter(this, void 0, void 0, function () {
            var filaFounded;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.filaTurmaRepository.queryById(id)];
                    case 1:
                        filaFounded = _b.sent();
                        if (!filaFounded) {
    ...
    HandleFilaTurmaService.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.filaTurmaRepository.deleteById(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HandleFilaTurmaService = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)("FilaTurmaRepository")),
        __metadata("design:paramtypes", [Object])
    ], HandleFilaTurmaService);
    return HandleFilaTurmaService;
}());
exports.HandleFilaTurmaService = HandleFilaTurmaService;
