...
var FilaTurma_1 = require("../../../infra/typeorm/entities/FilaTurma");
var connection;
var dateProvider;
describe("Handle CRUD routes related to fila_turma", function () {
    ...
    it("Should be able to update a fila_turma record", function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken, token, fila, response, responseResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post("/sessions").send({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    filaDeleted = filas.find(function (fila) { return fila.id_turma === 2 && fila.id === 2; });
                    expect(response.status).toBe(201);
