...
var HandleRestricoesService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.restricoesRepository.create({
                                siape: siape,
                                dia: dia,
                                letra: letra,
                            })];
    ...
    HandleRestricoesService.prototype.createMany = function (data) {
        return this.restricoesRepository.createMany(data);
    };
    HandleRestricoesService.prototype.deleteBySiape = function (siape) {
        return this.restricoesRepository.deleteBySiape(siape);
    };
    ...
    HandleRestricoesService = __decorate([
        ...
        __param(0, (0, tsyringe_1.inject)("RestricoesRepository")),
