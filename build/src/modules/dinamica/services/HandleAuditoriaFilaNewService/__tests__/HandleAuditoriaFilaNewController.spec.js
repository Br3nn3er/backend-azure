...
var AuditoriaFilaNew_1 = require("../../../infra/typeorm/entities/AuditoriaFilaNew");
var connection;
describe("Handle CRUD routes related to auditoria_fila_turma_new", function () {
    ...
    it("Should be able to update a auditoria_fila_turma_new record", function () { return __awaiter(void 0, void 0, void 0, function () {
