...
var AuditoriaFila_1 = require("../../../infra/typeorm/entities/AuditoriaFila");
var connection;
describe("Handle CRUD routes related to auditoria_fila", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    auditoria2 = new AuditoriaFila_1.AuditoriaFila();
    ...
    it("Should be able to update a auditoria_fila record", function () { return __awaiter(void 0, void 0, void 0, function () {
