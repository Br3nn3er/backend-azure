...
exports.HandleEtapaService = void 0;
var csv_parse_1 = __importDefault(require("csv-parse"));
var fs_1 = __importDefault(require("fs"));
var tsyringe_1 = require("tsyringe");
var AppError_1 = require("../../../../shared/errors/AppError");
var HandleEtapaService = /** @class */ (function () {
    function HandleEtapaService(etapaRepository) {
    ...
    HandleEtapaService.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.etapaRepository.deleteById(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HandleEtapaService.prototype.import = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            var etapas;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadEtapas(file)];
                    case 1:
                        etapas = _a.sent();
                        etapas.map(function (etapaToProcess) { return __awaiter(_this, void 0, void 0, function () {
                            var codigo, ativo, descricao;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        codigo = etapaToProcess.codigo, ativo = etapaToProcess.ativo, descricao = etapaToProcess.descricao;
                                        console.log(etapaToProcess);
                                        return [4 /*yield*/, this.etapaRepository.create({
                                                codigo: codigo,
                                                ativo: ativo,
                                                descricao: descricao,
                                            })];
    ...
    HandleEtapaService.prototype.loadEtapas = function (file) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            parseFile
                ...
                var codigo, ativo, descricao;
                return __generator(this, function (_a) {
                    codigo = line[0], ativo = line[1], descricao = line[2];
                    etapas.push({
                        codigo: codigo,
    ...
    HandleEtapaService = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)("EtapaRepository")),
        __metadata("design:paramtypes", [Object])
    ], HandleEtapaService);
    return HandleEtapaService;
}());
exports.HandleEtapaService = HandleEtapaService;
