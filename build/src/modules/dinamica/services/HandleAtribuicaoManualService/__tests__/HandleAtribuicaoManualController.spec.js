...
var AtribuicaoManual_1 = require("../../../infra/typeorm/entities/AtribuicaoManual");
var Cenario_1 = require("../../../infra/typeorm/entities/Cenario");
var connection;
var dateProvider;
describe("Handle CRUD routes related to atribuicao_manual", function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var id, password, professor, professor2, curso, disciplina, disciplina2, turma1, turma2, semestre1, semestre2, cenario, cenario2;
    ...
    it("Should be able to create a new atribuica_manual record", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it("Should be able to read all ministra records", function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken, token, atribuicao, response, responseResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post("/sessions").send({
                        email: "sodd_tcc@outlook.com",
                ...
                case 1:
                    ...
                    return [4 /*yield*/, connection.manager.save(atribuicao)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, supertest_1.default)(app_1.app)
    ...
    it("Should be able to delete a atribuicao_manual record", function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken, token, atribuicao, response, responseGet, listAtribuicoes, atribuicaoDeleted;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post("/sessions").send({
                        email: "sodd_tcc@outlook.com",
                ...
                case 4:
                    ...
                    atribuicaoDeleted = listAtribuicoes.find(function (atribuicao) { return atribuicao.num_cenario === 2 && atribuicao.id_turma === 1; });
                    expect(response.status).toBe(201);
