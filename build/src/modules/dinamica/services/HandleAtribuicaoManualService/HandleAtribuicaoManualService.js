...
var HandleAtribuicaoManualService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.atribuicaoRepository.create({
    ...
    HandleAtribuicaoManualService.prototype.loadAtribuicoes = function (file) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            parseFile
                ...
                .on("end", function () {
                fs_1.default.promises.unlink(file.path).then(function () { return resolve(atribuicoes); });
            })
    ...
    HandleAtribuicaoManualService = __decorate([
        ...
        __param(0, (0, tsyringe_1.inject)("AtribuicaoManualRepository")),
