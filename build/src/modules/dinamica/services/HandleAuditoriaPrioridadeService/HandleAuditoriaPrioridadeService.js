...
exports.HandleAuditoriaPrioridadeService = void 0;
var csv_parse_1 = __importDefault(require("csv-parse"));
var fs_1 = __importDefault(require("fs"));
var tsyringe_1 = require("tsyringe");
var AppError_1 = require("../../../../shared/errors/AppError");
var HandleAuditoriaPrioridadeService = /** @class */ (function () {
    function HandleAuditoriaPrioridadeService(auditoriaPrioridade) {
        this.auditoriaPrioridade = auditoriaPrioridade;
    }
    ...
    HandleAuditoriaPrioridadeService.prototype.read = function () {
        return __awaiter(this, void 0, void 0, function () {
            var auditorias;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.auditoriaPrioridade.listAllAuditorias()];
                    case 1:
                        auditorias = _a.sent();
    ...
    HandleAuditoriaPrioridadeService.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.auditoriaPrioridade.deleteById(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HandleAuditoriaPrioridadeService.prototype.import = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            var auditorias;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        auditorias.map(function (auditoriaToProcess) { return __awaiter(_this, void 0, void 0, function () {
                            var siape, codigo_disc, prioridade_antiga, prioridade_nova, stamp;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        siape = auditoriaToProcess.siape, codigo_disc = auditoriaToProcess.codigo_disc, prioridade_antiga = auditoriaToProcess.prioridade_antiga, prioridade_nova = auditoriaToProcess.prioridade_nova, stamp = auditoriaToProcess.stamp;
                                        console.log(auditoriaToProcess);
                                        return [4 /*yield*/, this.auditoriaPrioridade.create({
                                                siape: siape,
                                                codigo_disc: codigo_disc,
                                                prioridade_antiga: prioridade_antiga,
                                                prioridade_nova: prioridade_nova,
    ...
    HandleAuditoriaPrioridadeService.prototype.loadAuditorias = function (file) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            parseFile
                ...
                var siape, codigo_disc, prioridade_antiga, prioridade_nova, stamp;
                return __generator(this, function (_a) {
                    siape = line[0], codigo_disc = line[1], prioridade_antiga = line[2], prioridade_nova = line[3], stamp = line[4];
                    auditorias.push({
                        siape: siape,
                        codigo_disc: codigo_disc,
    ...
    HandleAuditoriaPrioridadeService = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)("AuditoriaPrioridadeRepository")),
        __metadata("design:paramtypes", [Object])
    ], HandleAuditoriaPrioridadeService);
    return HandleAuditoriaPrioridadeService;
}());
exports.HandleAuditoriaPrioridadeService = HandleAuditoriaPrioridadeService;
