...
exports.HandlePrioridadeService = void 0;
var csv_parse_1 = __importDefault(require("csv-parse"));
var fs_1 = __importDefault(require("fs"));
var tsyringe_1 = require("tsyringe");
var AppError_1 = require("../../../../shared/errors/AppError");
var HandlePrioridadeService = /** @class */ (function () {
    function HandlePrioridadeService(prioridadesRepository) {
    ...
    HandlePrioridadeService.prototype.read = function () {
        return __awaiter(this, void 0, void 0, function () {
            var listPrioridades;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prioridadesRepository.listAllPrioridades()];
                    case 1:
                        listPrioridades = _a.sent();
                        listPrioridades.forEach(function (prioridadeToTrim) {
    ...
    HandlePrioridadeService.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prioridadesRepository.deleteById(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HandlePrioridadeService.prototype.import = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            var listPrioridades;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadPrioridades(file)];
                    case 1:
                        listPrioridades = _a.sent();
                        listPrioridades.map(function (prioridadeToProcess) { return __awaiter(_this, void 0, void 0, function () {
                            var prioridade, codigo_disc, siape;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        prioridade = prioridadeToProcess.prioridade, codigo_disc = prioridadeToProcess.codigo_disc, siape = prioridadeToProcess.siape;
                                        console.log(prioridadeToProcess);
                                        return [4 /*yield*/, this.prioridadesRepository.create({
                                                prioridade: prioridade,
                                                codigo_disc: codigo_disc,
                                                siape: siape,
                                            })];
    ...
    HandlePrioridadeService.prototype.loadPrioridades = function (file) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            parseFile
                ...
                var prioridade, codigo_disc, siape;
                return __generator(this, function (_a) {
                    prioridade = line[0], codigo_disc = line[1], siape = line[2];
    ...
    HandlePrioridadeService = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)("PrioridadesRepository")),
        __metadata("design:paramtypes", [Object])
    ], HandlePrioridadeService);
    return HandlePrioridadeService;
}());
exports.HandlePrioridadeService = HandlePrioridadeService;
