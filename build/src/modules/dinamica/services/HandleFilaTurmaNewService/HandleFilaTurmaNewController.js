...
var HandleFilaTurmaNewController = /** @class */ (function () {
    ...
    HandleFilaTurmaNewController.prototype.readFromLoggedUserBySemestreId = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var semestreId, _a, isNotInQueue, handleFilaTurmaNewRepository, filas;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        semestreId = request.params.semestreId;
                        _a = request.query.isNotInQueue, isNotInQueue = _a === void 0 ? "false" : _a;
                        handleFilaTurmaNewRepository = tsyringe_1.container.resolve(HandleFilaTurmaNewService_1.HandleFilaTurmaNewService);
                        return [4 /*yield*/, handleFilaTurmaNewRepository.readByProfessorAndSemestreId(request.user.siape, parseInt(semestreId, 10), isNotInQueue === "true")];
                    case 1:
                        filas = _b.sent();
                        return [2 /*return*/, response.status(200).json(filas)];
                }
