...
var HandleFilaTurmaNewService = /** @class */ (function () {
    ...
    HandleFilaTurmaNewService.prototype.readByProfessorAndSemestreId = function (siape, semestreId, isNotInQueue) {
        if (isNotInQueue === void 0) { isNotInQueue = false; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, ano, semestre, list, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.semestresRepository.queryById(semestreId)];
                    case 1:
                        _a = _c.sent(), ano = _a.ano, semestre = _a.semestre;
                        if (!isNotInQueue) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.filaRepository.readByProfessorAndSemestreExcludingProfessor(siape, semestre, ano)];
                    case 2:
                        _b = _c.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.filaRepository.readByProfessorAndSemestre(siape, semestre, ano)];
                    case 4:
                        _b = _c.sent();
                        _c.label = 5;
                    case 5:
                        list = _b;
                        return [2 /*return*/, lodash_1.default.uniqBy(list, "id_turma")];
                }
            });
        });
    };
    ...
    HandleFilaTurmaNewService = __decorate([
        ...
        __param(0, (0, tsyringe_1.inject)("FilaTurmaNewRepository")),
