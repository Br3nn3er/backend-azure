            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(app_1.app)
                            ...
                            .set({
                            Authorization: "Bearer ".concat(firstToken),
                        })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, supertest_1.default)(app_1.app)
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post("/sessions").send({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(app_1.app)
                            .delete("/users/".concat(userToDelete.id))
                            .send()
                            .set({
                            Authorization: "Bearer ".concat(token),
                        })];
