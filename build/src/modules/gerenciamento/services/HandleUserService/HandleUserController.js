...
var HandleUserController = /** @class */ (function () {
    ...
    HandleUserController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, isAdmin, siape, handleUserService, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, email = _a.email, password = _a.password, isAdmin = _a.isAdmin, siape = _a.siape;
                        handleUserService = tsyringe_1.container.resolve(HandleUserService_1.HandleUserService);
                        data = { name: name, email: email, password: password, isAdmin: isAdmin, siape: siape };
                        if (isAdmin)
                            delete data.siape;
                        return [4 /*yield*/, handleUserService.create(data)];
                    case 1:
                        _b.sent();
