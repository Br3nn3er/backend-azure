...
var HandleUserService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        token = (0, jsonwebtoken_1.sign)({}, secret_token, {
                            subject: user.id,
                            expiresIn: expires_in_token,
                        });
                        refresh_token = (0, jsonwebtoken_1.sign)({ email: email }, secret_refresh_token, {
                            subject: user.id,
    ...
    HandleUserService.prototype.create = function (_a) {
        var name = _a.name, email = _a.email, password = _a.password, isAdmin = _a.isAdmin, siape = _a.siape;
        return __awaiter(this, void 0, void 0, function () {
            var hashedPassword, userExists;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, bcrypt_1.hash)(password, 8)];
                    case 1:
