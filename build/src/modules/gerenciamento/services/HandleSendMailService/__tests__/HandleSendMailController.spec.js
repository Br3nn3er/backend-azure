...
describe("Handle CRUD operations related to user", function () {
    ...
    it("Should be able to send an forgot password mail", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post("/password/forgot").send({
    ...
    it("Should not be able to send an forgot password mail to an unexisting password", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post("/password/forgot").send({
