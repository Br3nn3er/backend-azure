...
var ministraRoutes = (0, express_1.Router)();
...
ministraRoutes.get("/professor/semestre/:semestre", ensureAuthenticated_1.ensureAuthenticated, handleMinistraController.readByProfessorAndSemestre);
ministraRoutes.get("/turma/semestre/:semestre", ensureAuthenticated_1.ensureAuthenticated, handleMinistraController.readByTurmaAndSemestre);
