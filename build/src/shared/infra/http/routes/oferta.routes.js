...
var ofertaRoutes = (0, express_1.Router)();
...
ofertaRoutes.get("/turma/:turmaId/semestre/:semestreId", ensureAuthenticated_1.ensureAuthenticated, handleOfertaController.readByTurmaIdAndSemestreId);
