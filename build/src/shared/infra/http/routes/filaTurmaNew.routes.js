...
var filaTurmaNewRoutes = (0, express_1.Router)();
...
filaTurmaNewRoutes.get("/professor/semestre/:semestreId", ensureAuthenticated_1.ensureAuthenticated, handleFilaTurmaNewController.readFromLoggedUserBySemestreId);
